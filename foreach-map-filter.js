/*
Write a function called doubleValues which accepts an array and returns a new array with all the values in the array passed to the 
function doubled
...
/*
Write a function called showFirstAndLast which accepts an array of strings and returns a new array with only the first and last character 
of each string.
...
/*
Write a function called addKeyAndValue which accepts an array of objects, a key, and a value and returns the array passed to the function 
with the new key and value added for each object 
...
function addKeyAndValue(arr,key,value){
    //for each object in the array add the key and the title. 
    arr.forEach(function (val){
     val[key] = value;
    });
    return arr;  
...
function vowelCount(str){
 let splitArray = str.split(""); //splits a string into an array of substinrgs and returns the array.
 let obj = {};
 const vowels = "aeiou'";

splitArray.forEach(function(letter){ //for each index of the split array, eahc letter do the following function
    let lowerCasedLetter = letter.toLowerCase(); //make the letter lower case and save it to a variable. 
    if (vowels.indexOf(lowerCasedLetter) !== -1) {//if there are vowels then indexof will return 1, if there aren't it will return -1
        if (obj[lowerCasedLetter]){ //is it already there
            obj[lowerCasedLetter]++;//increment
        } else {
...
/*
Write a function called doubleValuesWithMap which accepts an array and returns a new array with all the values in the array passed to the 
function doubled
...
Examples:
    ...
    {first: 'Colt', last:"Steele", isCatOwner: true}], 'isCatOwner') // [{first: 'Tim', last:"Garcia", isCatOwner: true}, 
...
return str
    ...
    .split("")
    .filter(function(val){
        return vowels.indexOf(val) === -1 //return val when it is not a vowel
    })
    .join('');//join the letters, without the default comma
}
